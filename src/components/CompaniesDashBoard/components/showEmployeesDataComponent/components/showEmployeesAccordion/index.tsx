...
export default function ShowEmployeesAccordion({element}:IShowMovimentationsAccordion) {
  function setColor(){
  ...
  return (
    <div>
      <Accordion style={{width: "100%"}}>
        ...
        >
          <Typography style={{minWidth: "190px"}}><Span style={{minWidth: "190px"}}>{element.name} </Span> </Typography>
          <Typography ><Span >{element.email} </Span> </Typography>
