...
export default function ShowOrdersAccordion({element}:IShowMovimentationsAccordion) {
  function setColor(){
    ...
    <div>
      <Accordion style={{width: "100%"}}>
        ...
        >
          ...
          <Typography ><Span style={{color: "green"}}>R$ {element.value} </Span> </Typography>
        ...
        <span> {element.order_id}</span><br></br>
